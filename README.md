...
The script will:
    ...
    Initialize the atomic pumping function.

    Calculate the initial magnetic state based on strain.

    Run the numerical integration (this may take time depending on T_END).

    Generate frames in parallel.

    Save the results (logs and combined_dynamics.gif) in a new folder named breather_run_YYYYMMDD_HHMMSS.
...
ATOMIC_OMEGA	Frequency of the atomic breather (
...
D_DMI	Dzyaloshinskii-Moriya Interaction (
...
A_ANISOTROPY	Easy-plane anisotropy (
